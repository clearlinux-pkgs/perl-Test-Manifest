...
%prep
%setup -q -n Test-Manifest-2.022
cd %{_builddir}/Test-Manifest-2.022
...
cp %{_builddir}/Test-Manifest-2.022/LICENSE %{buildroot}/usr/share/package-licenses/perl-Test-Manifest/22bc6b9310295913e198979ee064ecc65120b04d
if test -f Makefile.PL; then
...
%files perl
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.30.3/Test/Manifest.pm
